...
const GenerateImages = () => {
  ...
  const imageStyle = ['Realistic','Gibhi Style','Anime Style','Cartoon Style','Fantasy Style','Realistic Style','3D Style','Portrait Style'] 
      ...
      <form onSubmit ={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
          {imageStyle.map((item)=>(
            ...
            className = {`text-xs px-4 py-1 border rounded-full cursor-pointed 
        ...
        <div className='my-6 flex items-center gap-2'>
          <label className='relative cursor-pointer'>
            ...
            <div className='w-9 h-5 bg-slate-300 rounded-full
              peer peer-checked:bg-green-500 transition'></div>
        ...
        <button disabled = {loading} className='w-full flex justify-center items-center items-center gap-2
