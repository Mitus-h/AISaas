          ...
          <div>
            ...
            <div className="text-sm space-y-2">
              ...
              <div className="flex items-center gap-2 pt-4">
                <input
                  className="border border-gray-500/30 placeholder-gray-500 focus:ring-2 ring-blue-600 outline-none w-full max-w-64 h-9 rounded-md px-2"
                  type="email"
                  placeholder="Enter your email"
                />
                <button className="bg-primary hover:bg-blue-700 transition-colors w-24 h-9 text-white rounded-md cursor-pointer">
                  Subscribe
                </button>
              </div>
            </div>
